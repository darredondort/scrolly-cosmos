...
function circleStream(stream, radius, delta, direction, t02, t12) {
  ...
  if (t02 == null) {
    ...
    if (direction > 0 ? t02 < t12 : t02 > t12) t02 += direction * tau5;
  }
...
function zoom_default2() {
  ...
  function dblclicked(event, ...args) {
    ...
    noevent_default3(event);
    if (duration > 0) select_default(this).transition().duration(duration).call(schedule, t12, p02, event);
    else select_default(this).call(zoom.transform, t12, p02, event);
  }
