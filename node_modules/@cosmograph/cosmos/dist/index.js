...
function Vi(e) {
  var t = e += "", n = t.indexOf(":");
  return n >= 0 && (t = e.slice(0, n)) !== "xmlns" && (e = e.slice(n + 1)), Rf.hasOwnProperty(t) ? { space: Rf[t], local: e } : e;
}
function Sd(e) {
  return function() {
...
function Ad(e) {
  ...
  for (var t = this._groups, n = t.length, r = new Array(n), i = 0; i < n; ++i)
    for (var o = t[i], f = o.length, s = r[i] = new Array(f), u, l, v = 0; v < f; ++v)
      (u = o[v]) && (l = e.call(u, u.__data__, v, o)) && ("__data__" in u && (l.__data__ = u.__data__), s[v] = l);
...
function kd(e) {
  typeof e == "function" ? e = Cd(e) : e = du(e);
  for (var t = this._groups, n = t.length, r = [], i = [], o = 0; o < n; ++o)
    for (var f = t[o], s = f.length, u, l = 0; l < s; ++l)
      (u = f[l]) && (r.push(e.call(u, u.__data__, l, f)), i.push(u));
  return new Nt(r, i);
}
function mu(e) {
  return function() {
...
function Id(e) {
  return this.select(e == null ? zd : Ld(typeof e == "function" ? e : pu(e)));
}
...
function Od(e) {
  return this.selectAll(e == null ? Dd : Md(typeof e == "function" ? e : pu(e)));
}
function Nd(e) {
...
function Vd(e, t, n, r, i, o) {
  for (var f = 0, s, u = t.length, l = o.length; f < l; ++f)
    (s = t[f]) ? (s.__data__ = o[f], r[f] = s) : n[f] = new zi(e, o[f]);
  for (; f < u; ++f)
    (s = t[f]) && (i[f] = s);
}
function $d(e, t, n, r, i, o, f) {
  ...
  for (s = 0; s < b; ++s)
    M = f.call(e, o[s], s, o) + "", (u = l.get(M)) ? (r[s] = u, u.__data__ = o[s], l.delete(M)) : n[s] = new zi(e, o[s]);
  for (s = 0; s < v; ++s)
...
function Ud(e, t) {
  ...
  for (var o = i.length, f = new Array(o), s = new Array(o), u = new Array(o), l = 0; l < o; ++l) {
    var v = r[l], b = i[l], S = b.length, M = Xd(e.call(v, v && v.__data__, l, r)), K = M.length, we = s[l] = new Array(K), ke = f[l] = new Array(K), ae = u[l] = new Array(S);
    n(v, b, we, ke, ae, M, t);
...
function qd(e) {
  for (var t = e.selection ? e.selection() : e, n = this._groups, r = t._groups, i = n.length, o = r.length, f = Math.min(i, o), s = new Array(i), u = 0; u < f; ++u)
...
function Yd() {
  for (var e = this._groups, t = -1, n = e.length; ++t < n; )
    for (var r = e[t], i = r.length - 1, o = r[i], f; --i >= 0; )
...
function Zd(e) {
  e || (e = Qd);
  function t(b, S) {
    return b && S ? e(b.__data__, S.__data__) : !b - !S;
  }
...
function mm(e, t, n) {
  return arguments.length > 1 ? this.each((t == null ? lm : typeof t == "function" ? dm : hm)(e, t, n ?? "")) : sr(this.node(), e);
}
function sr(e, t) {
...
function xm(e, t) {
  return arguments.length > 1 ? this.each((t == null ? pm : typeof t == "function" ? gm : vm)(e, t)) : this.node()[e];
}
function xu(e) {
...
function bu(e, t) {
  for (var n = da(e), r = -1, i = t.length; ++r < i; ) n.add(t[r]);
}
function _u(e, t) {
  for (var n = da(e), r = -1, i = t.length; ++r < i; ) n.remove(t[r]);
}
function ym(e) {
  return function() {
    bu(this, e);
...
function _m(e, t) {
  return function() {
    (t.apply(this, arguments) ? bu : _u)(this, e);
  };
}
function Sm(e, t) {
  var n = xu(e + "");
  if (arguments.length < 2) {
    for (var r = da(this.node()), i = -1, o = n.length; ++i < o; ) if (!r.contains(n[i])) return !1;
    return !0;
  }
...
function Em(e) {
  return arguments.length ? this.each(e == null ? wm : (typeof e == "function" ? Am : Tm)(e)) : this.node().textContent;
}
function Pm() {
  this.innerHTML = "";
}
...
function Fm(e) {
  return arguments.length ? this.each(e == null ? Pm : (typeof e == "function" ? km : Cm)(e)) : this.node().innerHTML;
}
function Lm() {
...
function Dm(e) {
  var t = typeof e == "function" ? e : hu(e);
...
function Om(e, t) {
  var n = typeof e == "function" ? e : hu(e), r = t == null ? Mm : typeof t == "function" ? t : ha(t);
  return this.select(function() {
  ...
  return function() {
    ...
    if (r) {
      for (var f = 0, s = r.length; f < s; ++f)
        if ((i = r[f]).type === e.type && i.name === e.name) {
...
function Qm(e, t) {
  return this.each((typeof t == "function" ? Zm : Ym)(e, t));
}
function* Km() {
  for (var e = this._groups, t = 0, n = e.length; t < n; ++t)
    for (var r = e[t], i = 0, o = r.length, f; i < o; ++i)
      (f = r[i]) && (yield f);
}
var wu = [null];
function Nt(e, t) {
...
function St(e) {
  return typeof e == "string" ? new Nt([[document.querySelector(e)]], [document.documentElement]) : new Nt([[e]], wu);
}
function ep(e) {
  let t;
...
Pi.prototype = $i.prototype = {
  constructor: Pi,
  on: function(e, t) {
    var n = this._, r = np(e + "", n), i, o = -1, f = r.length;
    if (arguments.length < 2) {
      for (; ++o < f; ) if ((i = (e = r[o]).type) && (i = rp(n[i], e.name))) return i;
      return;
    }
    if (t != null && typeof t != "function") throw new Error("invalid callback: " + t);
    for (; ++o < f; )
      if (i = (e = r[o]).type) n[i] = Df(n[i], e.name, t);
      else if (t == null) for (i in n) n[i] = Df(n[i], e.name, null);
    return this;
  },
  copy: function() {
    var e = {}, t = this._;
...
function Df(e, t, n) {
  for (var r = 0, i = e.length; r < i; ++r)
    if (e[r].name === t) {
      e[r] = tp, e = e.slice(0, r).concat(e.slice(r + 1));
      break;
    }
  return n != null && e.push({ name: t, value: n }), e;
}
var fr = 0, zr = 0, Fr = 0, Tu = 1e3, Ii, Ir, Ri = 0, Vn = 0, ji = 0, Dr = typeof performance == "object" && performance.now ? performance : Date, Au = typeof window == "object" && window.requestAnimationFrame ? window.requestAnimationFrame.bind(window) : function(e) {
  setTimeout(e, 17);
};
function ma() {
...
Di.prototype = Eu.prototype = {
  ...
  restart: function(e, t, n) {
    ...
    n = (n == null ? ma() : +n) + (t == null ? 0 : +t), !this._next && Ir !== this && (Ir ? Ir._next = this : Ii = this, Ir = this), this._call = e, this._time = n, Zo();
  },
  stop: function() {
...
function op() {
  ma(), ++fr;
  for (var e = Ii, t; e; )
    (t = Vn - e._time) >= 0 && e._call.call(null, t), e = e._next;
  --fr;
}
function Mf() {
...
function Zo(e) {
  if (!fr) {
    ...
    var t = e - Vn;
    t > 24 ? (e < 1 / 0 && (zr = setTimeout(Mf, e - Dr.now() - ji)), Fr && (Fr = clearInterval(Fr))) : (Fr || (Ri = Dr.now(), Fr = setInterval(ap, Tu)), fr = 1, Au(Mf));
  }
}
function Of(e, t, n) {
  var r = new Di();
...
var fp = $i("start", "end", "cancel", "interrupt"), up = [], Pu = 0, Nf = 1, Qo = 2, Ci = 3, Gf = 4, Ko = 5, ki = 6;
  ...
  function f(l) {
    ...
    for (v in r)
      if (M = r[v], M.name === n.name) {
        ...
        M.state === Gf ? (M.state = ki, M.timer.stop(), M.on.call("interrupt", e, e.__data__, M.index, M.group), delete r[v]) : +v < t && (M.state = ki, M.timer.stop(), M.on.call("cancel", e, e.__data__, M.index, M.group), delete r[v]);
      }
    if (Of(function() {
      ...
      for (n.state = Ci, i = new Array(S = n.tween.length), v = 0, b = -1; v < S; ++v)
        (M = n.tween[v].value.call(e, e.__data__, n.index, n.group)) && (i[++b] = M);
      i.length = b + 1;
    }
  }
  function s(l) {
...
function Fi(e, t) {
  var n = e.__transition, r, i, o = !0, f;
  if (n) {
    t = t == null ? null : t + "";
    for (f in n) {
      if ((r = n[f]).name !== t) {
      ...
      i = r.state > Qo && r.state < Ko, r.state = ki, r.timer.stop(), r.on.call(i ? "interrupt" : "cancel", e, e.__data__, r.index, r.group), delete n[f];
    }
...
var Mr = 0.7, Mi = 1 / Mr, or = "\\s*([+-]?\\d+)\\s*", Or = "\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)\\s*", nn = "\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)%\\s*", hp = /^#([0-9a-f]{3,8})$/, dp = new RegExp(`^rgb\\(${or},${or},${or}\\)$`), mp = new RegExp(`^rgb\\(${nn},${nn},${nn}\\)$`), pp = new RegExp(`^rgba\\(${or},${or},${or},${Or}\\)$`), vp = new RegExp(`^rgba\\(${nn},${nn},${nn},${Or}\\)$`), gp = new RegExp(`^hsl\\(${Or},${nn},${nn}\\)$`), xp = new RegExp(`^hsla\\(${Or},${nn},${nn},${Or}\\)$`), Bf = {
  aliceblue: 15792383,
...
function Sn(e) {
  var t, n;
  return e = (e + "").trim().toLowerCase(), (t = hp.exec(e)) ? (n = t[1].length, t = parseInt(t[1], 16), n === 6 ? jf(t) : n === 3 ? new Ft(t >> 8 & 15 | t >> 4 & 240, t >> 4 & 15 | t & 240, (t & 15) << 4 | t & 15, 1) : n === 8 ? bi(t >> 24 & 255, t >> 16 & 255, t >> 8 & 255, (t & 255) / 255) : n === 4 ? bi(t >> 12 & 15 | t >> 8 & 240, t >> 8 & 15 | t >> 4 & 240, t >> 4 & 15 | t & 240, ((t & 15) << 4 | t & 15) / 255) : null) : (t = dp.exec(e)) ? new Ft(t[1], t[2], t[3], 1) : (t = mp.exec(e)) ? new Ft(t[1] * 255 / 100, t[2] * 255 / 100, t[3] * 255 / 100, 1) : (t = pp.exec(e)) ? bi(t[1], t[2], t[3], t[4]) : (t = vp.exec(e)) ? bi(t[1] * 255 / 100, t[2] * 255 / 100, t[3] * 255 / 100, t[4]) : (t = gp.exec(e)) ? Hf(t[1], t[2] / 100, t[3] / 100, 1) : (t = xp.exec(e)) ? Hf(t[1], t[2] / 100, t[3] / 100, t[4]) : Bf.hasOwnProperty(e) ? jf(Bf[e]) : e === "transparent" ? new Ft(NaN, NaN, NaN, 0) : null;
}
function jf(e) {
...
function _p(e) {
  return e instanceof Br || (e = Sn(e)), e ? (e = e.rgb(), new Ft(e.r, e.g, e.b, e.opacity)) : new Ft();
}
function Jo(e, t, n, r) {
  return arguments.length === 1 ? _p(e) : new Ft(e, t, n, r ?? 1);
}
function Ft(e, t, n, r) {
...
va(Ft, Jo, Cu(Br, {
  brighter(e) {
    return e = e == null ? Mi : Math.pow(Mi, e), new Ft(this.r * e, this.g * e, this.b * e, this.opacity);
  },
  darker(e) {
    return e = e == null ? Mr : Math.pow(Mr, e), new Ft(this.r * e, this.g * e, this.b * e, this.opacity);
  },
  rgb() {
    return this;
  },
...
function ku(e) {
  ...
  if (e instanceof Br || (e = Sn(e)), !e) return new Wt();
  if (e instanceof Wt) return e;
  e = e.rgb();
  var t = e.r / 255, n = e.g / 255, r = e.b / 255, i = Math.min(t, n, r), o = Math.max(t, n, r), f = NaN, s = o - i, u = (o + i) / 2;
  return s ? (t === o ? f = (n - r) / s + (n < r) * 6 : n === o ? f = (r - t) / s + 2 : f = (t - n) / s + 4, s /= u < 0.5 ? o + i : 2 - o - i, f *= 60) : s = u > 0 && u < 1 ? 0 : f, new Wt(f, s, u, e.opacity);
}
function wp(e, t, n, r) {
  return arguments.length === 1 ? ku(e) : new Wt(e, t, n, r ?? 1);
}
function Wt(e, t, n, r) {
...
va(Wt, wp, Cu(Br, {
  brighter(e) {
    return e = e == null ? Mi : Math.pow(Mi, e), new Wt(this.h, this.s, this.l * e, this.opacity);
  },
  darker(e) {
    return e = e == null ? Mr : Math.pow(Mr, e), new Wt(this.h, this.s, this.l * e, this.opacity);
  },
  rgb() {
    var e = this.h % 360 + (this.h < 0) * 360, t = isNaN(e) || isNaN(this.s) ? 0 : this.s, n = this.l, r = n + (n < 0.5 ? n : 1 - n) * t, i = 2 * n - r;
    return new Ft(
      Uo(e >= 240 ? e - 240 : e + 120, i, r),
      Uo(e, i, r),
      Uo(e < 120 ? e + 240 : e - 120, i, r),
      this.opacity
    );
  },
  clamp() {
  ...
  formatHsl() {
    const e = Oi(this.opacity);
    return `${e === 1 ? "hsl(" : "hsla("}${Wf(this.h)}, ${_i(this.s) * 100}%, ${_i(this.l) * 100}%${e === 1 ? ")" : `, ${e})`}`;
  }
}));
function Wf(e) {
...
function Ep(e) {
  return (e = +e) == 1 ? Fu : function(t, n) {
    return n - t ? Ap(t, n, e) : ga(isNaN(t) ? n : t);
  };
}
function Fu(e, t) {
  var n = t - e;
  return n ? Tp(e, n) : ga(isNaN(e) ? t : e);
}
...
function kp(e, t) {
  var n = t ? t.length : 0, r = e ? Math.min(n, e.length) : 0, i = new Array(r), o = new Array(n), f;
  for (f = 0; f < r; ++f) i[f] = xa(e[f], t[f]);
  for (; f < n; ++f) o[f] = t[f];
  return function(s) {
...
function Lp(e, t) {
  ...
  for (i in t)
    i in e ? n[i] = xa(e[i], t[i]) : r[i] = t[i];
  return function(o) {
    for (i in n) r[i] = n[i](o);
    return r;
  };
}
var ea = /[-+]?(?:\d+\.?\d*|\.?\d+)(?:[eE][-+]?\d+)?/g, Xo = new RegExp(ea.source, "g");
function zp(e) {
  return function() {
    return e;
  };
...
function Lu(e, t) {
  ...
  for (e = e + "", t = t + ""; (r = ea.exec(e)) && (i = Xo.exec(t)); )
...
function xa(e, t) {
  var n = typeof t, r;
  return t == null || n === "boolean" ? ga(t) : (n === "number" ? Ht : n === "string" ? (r = Sn(t)) ? (t = r, Ni) : Lu : t instanceof Sn ? Ni : t instanceof Date ? Fp : Cp(t) ? Pp : Array.isArray(t) ? kp : typeof t.valueOf != "function" && typeof t.toString != "function" || isNaN(t) ? Lp : Ht)(e, t);
}
function Rp(e, t) {
  return e = +e, t = +t, function(n) {
...
function zu(e, t, n, r, i, o) {
  var f, s, u;
  return (f = Math.sqrt(e * e + t * t)) && (e /= f, t /= f), (u = e * n + t * r) && (n -= e * u, r -= t * u), (s = Math.sqrt(n * n + r * r)) && (n /= s, r /= s, u /= s), e * r < t * n && (e = -e, t = -t, u = -u, f = -f), {
    translateX: i,
    translateY: o,
...
function Mp(e) {
  return e == null || (Si || (Si = document.createElementNS("http://www.w3.org/2000/svg", "g")), Si.setAttribute("transform", e), !(e = Si.transform.baseVal.consolidate())) ? ta : (e = e.matrix, zu(e.a, e.b, e.c, e.d, e.e, e.f));
}
function Iu(e, t, n, r) {
  function i(l) {
  ...
  return function(l, v) {
    var b = [], S = [];
    return l = e(l), v = e(v), o(l.translateX, l.translateY, v.translateX, v.translateY, b, S), f(l.rotate, v.rotate, b, S), s(l.skewX, v.skewX, b, S), u(l.scaleX, l.scaleY, v.scaleX, v.scaleY, b, S), l = v = null, function(M) {
      for (var K = -1, we = S.length, ke; ++K < we; ) b[(ke = S[K]).i] = ke.x(M);
      return b.join("");
    };
  };
}
var Op = Iu(Dp, "px, ", "px)", "deg)"), Np = Iu(Mp, ", ", ")", ")"), Gp = 1e-12;
function Yf(e) {
...
function Xp(e, t) {
  ...
  return this.each((t == null ? jp : Up)(n, e, t));
}
function ya(e, t, n) {
  var r = e._id;
...
function Ru(e, t) {
  var n;
  return (typeof t == "number" ? Ht : t instanceof Sn ? Ni : (n = Sn(t)) ? (t = n, Ni) : Lu)(e, t);
}
function Hp(e) {
  return function() {
    this.removeAttribute(e);
...
function Zp(e, t, n) {
  ...
  return function() {
    var f, s = n(this), u;
    return s == null ? void this.removeAttribute(e) : (f = this.getAttribute(e), u = s + "", f === u ? null : f === r && u === i ? o : (i = u, o = t(r = f, s)));
  };
}
function Qp(e, t, n) {
  var r, i, o;
  return function() {
    var f, s = n(this), u;
    return s == null ? void this.removeAttributeNS(e.space, e.local) : (f = this.getAttributeNS(e.space, e.local), u = s + "", f === u ? null : f === r && u === i ? o : (i = u, o = t(r = f, s)));
  };
}
function Kp(e, t) {
  var n = Vi(e), r = n === "transform" ? Np : Ru;
  return this.attrTween(e, typeof t == "function" ? (n.local ? Qp : Zp)(n, r, ya(this, "attr." + e, t)) : t == null ? (n.local ? Wp : Hp)(n) : (n.local ? Yp : qp)(n, r, t));
}
function Jp(e, t) {
  return function(n) {
...
function a0(e) {
  var t = this._id;
  return arguments.length ? this.each((typeof e == "function" ? i0 : o0)(t, e)) : Yt(this.node(), t).delay;
}
function s0(e, t) {
  return function() {
...
function u0(e) {
  var t = this._id;
  return arguments.length ? this.each((typeof e == "function" ? s0 : f0)(t, e)) : Yt(this.node(), t).duration;
}
function c0(e, t) {
  if (typeof t != "function") throw new Error();
  return function() {
...
function l0(e) {
  var t = this._id;
  return arguments.length ? this.each(c0(t, e)) : Yt(this.node(), t).ease;
}
function h0(e, t) {
  return function() {
    var n = t.apply(this, arguments);
...
function d0(e) {
  ...
  return this.each(h0(this._id, e));
}
function m0(e) {
  typeof e != "function" && (e = mu(e));
  for (var t = this._groups, n = t.length, r = new Array(n), i = 0; i < n; ++i)
...
function p0(e) {
  ...
  for (var t = this._groups, n = e._groups, r = t.length, i = n.length, o = Math.min(r, i), f = new Array(r), s = 0; s < o; ++s)
...
function g0(e, t, n) {
  ...
  return function() {
    var f = o(this, e), s = f.on;
    s !== r && (i = (r = s).copy()).on(t, n), f.on = i;
  };
}
function x0(e, t) {
  var n = this._id;
  return arguments.length < 2 ? Yt(this.node(), n).on.on(e) : this.each(g0(n, e, t));
}
function y0(e) {
  return function() {
...
function _0(e) {
  ...
  for (var r = this._groups, i = r.length, o = new Array(i), f = 0; f < i; ++f)
    for (var s = r[f], u = s.length, l = o[f] = new Array(u), v, b, S = 0; S < u; ++S)
      (v = s[S]) && (b = e.call(v, v.__data__, S, s)) && ("__data__" in v && (b.__data__ = v.__data__), l[S] = b, Ui(l[S], t, n, S, l, Yt(v, n)));
...
function S0(e) {
  ...
  for (var r = this._groups, i = r.length, o = [], f = [], s = 0; s < i; ++s)
    for (var u = r[s], l = u.length, v, b = 0; b < l; ++b)
      if (v = u[b]) {
        for (var S = e.call(v, v.__data__, b, u), M, K = Yt(v, n), we = 0, ke = S.length; we < ke; ++we)
...
function A0(e, t) {
  var n, r, i;
  return function() {
    var o = sr(this, e), f = (this.style.removeProperty(e), sr(this, e));
...
function P0(e, t, n) {
  var r, i, o;
  return function() {
    var f = sr(this, e), s = n(this), u = s + "";
    return s == null && (u = s = (this.style.removeProperty(e), sr(this, e))), f === u ? null : f === r && u === i ? o : (i = u, o = t(r = f, s));
  };
}
function C0(e, t) {
  var n, r, i, o = "style." + t, f = "end." + o, s;
  return function() {
    var u = rn(this, e), l = u.on, v = u.value[o] == null ? s || (s = Du(t)) : void 0;
    (l !== n || i !== v) && (r = (n = l).copy()).on(f, i = v), u.on = r;
  };
}
function k0(e, t, n) {
  var r = (e += "") == "transform" ? Op : Ru;
  return t == null ? this.styleTween(e, A0(e, r)).on("end.style." + e, Du(e)) : typeof t == "function" ? this.styleTween(e, P0(e, r, ya(this, "style." + e, t))).each(C0(this._id, e)) : this.styleTween(e, E0(e, r, t), n).on("end.style." + e, null);
}
function F0(e, t, n) {
  return function(r) {
...
function D0(e) {
  return this.tween("text", typeof e == "function" ? R0(ya(this, "text", e)) : I0(e == null ? "" : e + ""));
}
function M0(e) {
  return function(t) {
...
function N0(e) {
  ...
  if (typeof e != "function") throw new Error();
  return this.tween(t, O0(e));
}
function G0() {
  for (var e = this._name, t = this._id, n = Mu(), r = this._groups, i = r.length, o = 0; o < i; ++o)
...
function B0() {
  ...
  return new Promise(function(o, f) {
    ...
    n.each(function() {
      ...
      v !== e && (t = (e = v).copy(), t._.cancel.push(s), t._.interrupt.push(s), t._.end.push(u)), l.on = t;
    }), i === 0 && o();
  });
}
var V0 = 0;
...
function q0(e) {
  var t, n;
  e instanceof ln ? (t = e._id, e = e._name) : (t = Mu(), (n = H0).time = ma(), e = e == null ? null : e + "");
  for (var r = this._groups, i = r.length, o = 0; o < i; ++o)
    for (var f = r[o], s = f.length, u, l = 0; l < s; ++l)
      (u = f[l]) && Ui(u, e, t, l, f, n || W0(u, t));
...
`, "color:red;text-decoration:underline;font-weight:bold"), ie.lines.forEach(function(te) {
    ...
    function pc(a, h, _) {
      ...
      a !== document.body && typeof ResizeObserver == "function" ? (I = new ResizeObserver(function() {
        setTimeout(j);
      }), I.observe(a)) : window.addEventListener("resize", j, !1);
      function G() {
    ...
    function yc(a) {
      var h = a || {}, _, R, j, I, G = {}, Z = [], Y = [], ne = typeof window > "u" ? 1 : window.devicePixelRatio, ie = !1, re = function(te) {
        te && d.raise(te);
      }, fe = function() {
      };
      if (typeof h == "string" ? (d(
        ...
        G.premultipliedAlpha === void 0 && (G.premultipliedAlpha = !0), I = vc(j, G);
      }
      return I ? {
        gl: I,
        canvas: j,
    ...
    var kc = 3408, Fc = 3410, Lc = 3411, zc = 3412, Ic = 3413, Rc = 3414, Dc = 3415, Mc = 33901, Oc = 33902, Nc = 3379, Gc = 3386, Bc = 34921, Vc = 36347, $c = 36348, jc = 35661, Uc = 35660, Xc = 34930, Hc = 36349, Wc = 34076, qc = 34024, Yc = 7936, Zc = 7937, Qc = 7938, Kc = 35724, Jc = 34047, el = 36063, tl = 34852, $r = 3553, ja = 34067, nl = 34069, rl = 33984, dr = 6408, Wi = 5126, Ua = 5121, qi = 36160, il = 36053, ol = 36064, al = 16384, sl = function(a, h) {
      ...
      if (I) {
        ...
        if (a.bindFramebuffer(qi, Z), a.framebufferTexture2D(qi, ol, $r, G, 0), a.bindTexture($r, null), a.checkFramebufferStatus(qi) !== il) I = !1;
        else {
          a.viewport(0, 0, 1, 1), a.clearColor(1, 0, 0, 1), a.clear(al);
          var Y = ht.allocType(Wi, 4);
          a.readPixels(0, 0, 1, 1, dr, Wi, Y), a.getError() ? I = !1 : (a.deleteFramebuffer(Z), a.deleteTexture(G), I = Y[0] === 1), ht.freeType(Y);
        }
      }
    ...
    function wl(a, h, _, R) {
      ...
      function Y(C, O) {
        var ee = Z.pop();
        return ee || (ee = new G(C)), ee.bind(), re(ee, O, Sl, 0, 1, !1), ee;
      }
      function ne(C) {
        Z.push(C);
      }
    ...
    function Dl(a, h, _, R) {
      ...
      function Q(te, C) {
        var O = _.create(null, Ji, !0), ee = new Z(O._buffer);
        R.elementsCount++;
        function ge(W) {
          if (!W)
    ...
    function go(a) {
      if (!a)
        return !1;
      var h = Pn(a);
      return oh.indexOf(h) >= 0 ? !0 : _s(a) || Ss(a) || Ut(a);
    }
    function As(a) {
      return Yi[Object.prototype.toString.call(a)] | 0;
    }
    ...
    function hh(a, h, _, R, j, I, G) {
      ...
      function U() {
        this.internalformat = En, this.format = En, this.type = Wn, this.compressed = !1, this.premultiplyAlpha = !1, this.flipY = !1, this.unpackAlignment = 1, this.colorSpace = ms, this.width = 0, this.height = 0, this.channels = 0;
      }
      function $(x, D) {
      ...
      function be(x, D) {
        if (!(typeof D != "object" || !D)) {
          ...
          var ye = x.width, Ue = x.height, m = x.channels, c = !1;
          "shape" in D ? (d(
            Array.isArray(D.shape) && D.shape.length >= 2,
            "shape must be an array"
          ), ye = D.shape[0], Ue = D.shape[1], D.shape.length === 3 && (m = D.shape[2], d(m > 0 && m <= 4, "invalid number of channels"), c = !0), d(ye >= 0 && ye <= _.maxTextureSize, "invalid width"), d(Ue >= 0 && Ue <= _.maxTextureSize, "invalid height")) : ("radius" in D && (ye = Ue = D.radius, d(ye >= 0 && ye <= _.maxTextureSize, "invalid radius")), "width" in D && (ye = D.width, d(ye >= 0 && ye <= _.maxTextureSize, "invalid width")), "height" in D && (Ue = D.height, d(Ue >= 0 && Ue <= _.maxTextureSize, "invalid height")), "channels" in D && (m = D.channels, d(m > 0 && m <= 4, "invalid number of channels"), c = !0)), x.width = ye | 0, x.height = Ue | 0, x.channels = m | 0;
          var w = !1;
          if ("format" in D) {
            var P = D.format;
            d(
            ...
            x.format = Ee[k], P in fe && ("type" in D || (x.type = fe[P])), P in te && (x.compressed = !0), w = !0;
          }
      ...
      function J() {
        U.call(this), this.xOffset = 0, this.yOffset = 0, this.data = null, this.needsFree = !1, this.element = null, this.needsCopy = !1;
      }
      function ce(x, D) {
        var z = null;
        if (go(D) ? z = D : D && (d.type(D, "object", "invalid pixel data type"), be(x, D), "x" in D && (x.xOffset = D.x | 0), "y" in D && (x.yOffset = D.y | 0), go(D.data) && (z = D.data)), d(
          ...
          x.width = x.width || ye - x.xOffset, x.height = x.height || Ue - x.yOffset, x.needsCopy = !0, d(
          ...
          x.channels = x.channels || 4, ch(x, z), x.alignment = 1, x.needsFree = !0;
        else if (Ut(z)) {
          var m = z.data;
          !Array.isArray(m) && x.type === Wn && (x.type = As(m));
          var c = z.shape, w = z.stride, P, k, A, T, E, p;
          c.length === 3 ? (A = c[2], p = w[2]) : (d(c.length === 2, "invalid ndarray pixel data, must be 2 or 3D"), A = 1, p = 1), P = c[0], k = c[1], T = w[0], E = w[1], x.alignment = 1, x.width = P, x.height = k, x.channels = A, x.format = x.internalformat = Qr[A], x.needsFree = !0, lh(x, m, T, E, p, z.offset);
          ...
          for (var F = jr.shape(z), V = 1, X = 0; X < F.length; ++X)
            V *= F[X];
          var se = Es(x, V);
          jr.flatten(z, F, "", se), Ps(x, se), x.alignment = 1, x.width = y, x.height = g, x.channels = L, x.format = x.internalformat = Qr[L], x.needsFree = !0;
        }
        x.type === vr ? d(
      ...
      function Fe() {
        U.call(this), this.genMipmaps = !1, this.mipmapHint = Zr, this.mipmask = 0, this.images = Array(16);
      }
      function Oe(x, D, z) {
      ...
      function it() {
        this.minFilter = mo, this.magFilter = mo, this.wrapS = ho, this.wrapT = ho, this.anisotropic = 1, this.genMipmaps = !1, this.mipmapHint = Zr;
      }
      function mt(x, D) {
        if ("min" in D) {
          var z = D.min;
          d.parameter(z, ie), x.minFilter = ie[z], ih.indexOf(x.minFilter) >= 0 && !("faces" in D) && (x.genMipmaps = !0);
        }
        if ("mag" in D) {
          var ye = D.mag;
          ...
          switch (typeof D.mipmap) {
            case "string":
              d.parameter(
                ...
                Z,
                "invalid mipmap hint"
              ), x.mipmapHint = Z[D.mipmap], x.genMipmaps = !0, A = !0;
              break;
            case "boolean":
              A = x.genMipmaps = D.mipmap;
              break;
            case "object":
              d(Array.isArray(D.mipmap), "invalid mipmap type"), x.genMipmaps = !1, A = !0;
              break;
            default:
    ...
    function Ih(a, h, _, R, j, I) {
      ...
      function $(J, ce) {
        ...
        function Me(de, ve) {
          ...
          var Oe = 0, Xe = 0, at = !0, ft = !0, Ze = null, pt = !0, it = "rgba", mt = "uint8", vt = 1, gt = null, _t = null, At = null, ct = !1;
          if (typeof de == "number")
            Oe = de | 0, Xe = ve | 0 || Oe;
          else if (!de)
            Oe = Xe = 1;
            ...
            ), it = "rgba32f"), d.oneOf(mt, ne, "invalid color type")), "colorFormat" in Ve && (it = Ve.colorFormat, Z.indexOf(it) >= 0 ? pt = !0 : Y.indexOf(it) >= 0 ? pt = !1 : d.optional(function() {
              pt ? d.oneOf(
                Ve.colorFormat,
                Z,
            ...
            )), "depth" in Ve && (typeof Ve.depth == "boolean" ? at = Ve.depth : (gt = Ve.depth, ft = !1)), "stencil" in Ve && (typeof Ve.stencil == "boolean" ? ft = Ve.stencil : (_t = Ve.stencil, at = !1)), "depthStencil" in Ve && (typeof Ve.depthStencil == "boolean" ? at = ft = Ve.depthStencil : (At = Ve.depthStencil, at = !1, ft = !1));
          }
      ...
      function ue() {
        G.cur = null, G.next = null, G.dirty = !0, Mt(W).forEach(function(J) {
    ...
    function bo() {
      this.state = 0, this.x = 0, this.y = 0, this.z = 0, this.w = 0, this.buffer = null, this.size = 0, this.normalized = !1, this.type = Rh, this.offset = 0, this.stride = 0, this.divisor = 0;
    }
    function Dh(a, h, _, R, j, I, G) {
      ...
      function me() {
        this.id = ++ie, this.attributes = [], this.elements = null, this.ownsElements = !1, this.count = 0, this.offset = 0, this.instances = -1, this.primitive = 4;
        var U = te();
      ...
      me.prototype.bindAttrs = function() {
        ...
        this.ownsElements && (this.elements.destroy(), this.elements = null, this.ownsElements = !1), re[this.id] && (delete re[this.id], R.vaoCount -= 1);
      };
      function he() {
        var U = te();
      ...
      function Ee(U) {
        ...
        function be(ue) {
          var J;
          if (Array.isArray(ue))
            J = ue, $.elements && $.ownsElements && $.elements.destroy(), $.elements = null, $.ownsElements = !1, $.offset = 0, $.count = 0, $.instances = -1, $.primitive = 4;
          else {
            if (d(typeof ue == "object", "invalid arguments for create vao"), d("attributes" in ue, "must specify attributes for vao"), ue.elements) {
              var ce = ue.elements;
              $.ownsElements ? typeof ce == "function" && ce._reglType === "elements" ? ($.elements.destroy(), $.ownsElements = !1) : ($.elements(ce), $.ownsElements = !1) : I.getElements(ue.elements) ? ($.elements = ue.elements, $.ownsElements = !1) : ($.elements = I.create(ue.elements), $.ownsElements = !0);
            } else
        ...
        return be.destroy = function() {
          ...
          $.buffers.length = 0, $.ownsElements && ($.elements.destroy(), $.elements = null, $.ownsElements = !1), $.destroy();
...
`), Q = Function.apply(null, h.concat(fe));
    ...
    function Ct(a, h) {
      ...
      if (_ === So) {
        ...
        if (_ === Qs) {
          for (var I = !1, G = !1, Z = !1, Y = 0; Y < a.data.length; ++Y) {
            var ne = a.data[Y];
            if (ne.type === wo)
              Z = !0;
            else if (ne.type === To)
    ...
    function cd(a, h, _, R, j, I, G, Z, Y, ne, ie, re, fe, Q, te) {
      ...
      ue(Ks, Kh), ue(Js, Qh), J(ef, "blendColor", [0, 0, 0, 0]), J(
        ...
        "blendFuncSeparate",
        [bf, yf, bf, yf]
      ), ue(tf, ed, !0), J(nf, "depthFunc", fd), J(rf, "depthRange", [0, 1]), J(of, "depthMask", !0), J(Co, Co, [!0, !0, !0, !0]), ue(af, Zh), J(sf, "cullFace", In), J(ko, ko, $o), J(Fo, Fo, 1), ue(ff, nd), J(Lo, "polygonOffset", [0, 0]), ue(uf, rd), ue(cf, id), J(zo, "sampleCoverage", [1, !1]), ue(lf, Jh), J(hf, "stencilMask", -1), J(Io, "stencilFunc", [sd, 0, -1]), J(
        Ro,
        "stencilOpSeparate",
        [kr, gn, gn, gn]
      ), J(
      ...
      function Fe(m, c, w) {
        ...
        function A(p) {
          if (p in P) {
            ...
            var g = !0, L = y.x | 0, F = y.y | 0, V, X;
            return "width" in y ? (V = y.width | 0, d.command(V >= 0, "invalid " + p, w.commandStr)) : g = !1, "height" in y ? (X = y.height | 0, d.command(X >= 0, "invalid " + p, w.commandStr)) : g = !1, new xt(
              !g && c && c.thisDep,
              !g && c && c.contextDep,
              !g && c && c.propDep,
              function(Ae, xe) {
      ...
      function at(m, c) {
        var w = m.static, P = m.dynamic, k = {}, A = !1;
        function T() {
          if (wr in w) {
            var xe = w[wr];
            return xe !== null && ne.getVAO(xe) === null && (xe = ne.createVAO(xe)), A = !0, k.vao = xe, dt(function(B) {
              var Se = ne.getVAO(xe);
        ...
        function y() {
          if (Fn in w) {
            ...
            if (k.elements = xe, gi(xe)) {
              var H = k.elements = I.create(xe, !0);
              xe = I.getElements(H), p = !0;
            } else xe && (xe = I.getElements(xe), p = !0, d.command(xe, "invalid elements", c.commandStr));
      ...
      function mt(m, c, w, P, k) {
        ...
        if (se.profile = de(m), se.uniforms = Ze(w, k), se.drawVAO = se.scopeVAO = g.vao, !se.drawVAO && F.program && !E && _.angle_instanced_arrays && g.static.elements) {
          var Ie = !0, Ae = F.program.attributes.map(function(H) {
            var B = c.static[H];
            return Ie = Ie && !!B, B;
          });
          if (Ie && Ae.length > 0) {
        ...
        return E ? se.useVAO = !0 : se.attributes = pt(c, k), se.context = it(P), se;
      }
      function vt(m, c, w) {
      ...
      function lt(m, c) {
        var w = m.proc("draw", 1);
        ct(m, w), vt(m, w, c.context), gt(m, w, c.framebuffer), _t(m, w, c), At(m, w, c.state), Ve(m, w, c, !1, !0);
      ...
      function Kt(m, c, w, P) {
        ...
        Et(m, c, w, P.attributes, k), Ke(m, c, w, P.uniforms, k, !1), Ce(m, c, c, w);
      }
      function Rn(m, c, w, P) {
        ct(m, c);
        ...
        if (w.needsContext && vt(m, g, w.context), w.needsFramebuffer && gt(m, g, w.framebuffer), At(m, g, w.state, L), w.profile && L(w.profile) && Ve(m, g, w, !1, !0), P)
          w.useVAO ? w.drawVAO ? L(w.drawVAO) ? g(m.shared.vao, ".setVAO(", w.drawVAO.append(m, g), ");") : y(m.shared.vao, ".setVAO(", w.drawVAO.append(m, y), ");") : y(m.shared.vao, ".setVAO(", m.shared.vao, ".targetVAO);") : (y(m.shared.vao, ".setVAO(null);"), Et(m, y, w, P.attributes, F), Et(m, g, w, P.attributes, L)), Ke(m, y, w, P.uniforms, F, !1), Ke(m, g, w, P.uniforms, L, !0), Ce(m, y, g, w);
        else {
      ...
      function x(m, c) {
        ...
        }), P || (vt(m, w, c.context), k = !1);
        var A = c.framebuffer, T = !1;
        A ? (A.propDep ? P = T = !0 : A.contextDep && P && (T = !0), T || gt(m, w, A)) : gt(m, w, null), c.state.viewport && c.state.viewport.propDep && (P = !0);
        function E(V) {
          return V.contextDep && P || V.propDep;
        }
        _t(m, w, c), At(m, w, c.state, function(V) {
          return !E(V);
        }), (!c.profile || !E(c.profile)) && Ve(m, w, c, !1, "a1"), c.contextDep = P, c.needsContext = k, c.needsFramebuffer = T;
      ...
      function D(m, c) {
        ...
        }), Ve(m, w, c, !0, !0), [Fn, ai, zn, si, Ln].forEach(
          function(T) {
            var E = c.draw[T];
      ...
      function ye(m, c, w) {
        ...
        if (!P || !z(P))
          return;
        var k = m.global, A = Object.keys(P), T = !1, E = !1, p = !1, y = m.global.def("{}");
      ...
      return {
        ...
        procs: function() {
          ...
          P(E, ".dirty=false;"), gt(m, c), gt(m, w, null, !0);
          var p;
    ...
    function _d(a) {
      ...
      function at(Ce) {
        Ce.preventDefault(), j = !0, Xe(), Me.forEach(function(He) {
          He();
        });
      }
      function ft(Ce) {
        _.getError(), j = !1, I.restore(), he.restore(), ee.restore(), Ee.restore(), U.restore(), $.restore(), W.restore(), ne && ne.restore(), be.procs.refresh(), Oe(), Re.forEach(function(He) {
          He();
        });
      }
      ce && (ce.addEventListener(Cf, at, !1), ce.addEventListener(kf, ft, !1));
      function Ze() {
      ...
      function pt(Ce) {
        ...
        var lt = Qe(Ce.context || {}, !0), Kt = Qe(Ce.uniforms || {}, !0), Rn = Qe(Ce.attributes || {}, !1), x = Qe(He(Ce), !1), D = {
          gpuTime: 0,
          cpuTime: 0,
          count: 0
      ...
      var Ke = r(pt, {
        ...
        // Resources
        buffer: function(Ce) {
          return ee.create(Ce, xd, !1, !1);
        },
        elements: function(Ce) {
          return ge.create(Ce, !1);
        },
        texture: Ee.create2D,
        cube: Ee.createCube,
...
var Z0 = Ou.exports;
const Q0 = /* @__PURE__ */ ba(Z0), K0 = "#b3b3b3", J0 = 0.1, ev = 4, tv = "#666666", nv = 0.1, rv = 1, iv = "#222222", We = {
  disableSimulation: !1,
  spaceSize: 4096,
  pointSizeScale: 1,
  linkWidthScale: 1,
...
}, ov = 0.7, av = 0.95, sv = 3, fv = (e) => typeof e == "function", Nu = (e) => Array.isArray(e), uv = (e) => e instanceof Object, cv = (e) => e instanceof Object ? e.constructor.name !== "Function" && e.constructor.name !== "Object" : !1, Zf = (e) => uv(e) && !Nu(e) && !fv(e) && !cv(e);
function ur(e) {
  let t;
  if (Nu(e))
    t = e;
  else {
    const n = Sn(e), r = n == null ? void 0 : n.rgb();
...
function wi(e) {
  var t;
  e && (t = e == null ? void 0 : e._framebuffer) != null && t.framebuffer && e.destroy();
}
var $n = `#ifdef GL_ES
precision highp float;
#endif
...
var na = /* @__PURE__ */ ((e) => (e.OUTGOING = "outgoing", e.INCOMING = "incoming", e))(na || {});
class Qf extends dn {
  constructor() {
...
`;
    class i {
       ...
       */
      addUI(f) {
        this.names.indexOf(f) == -1 && (this.names.push(f), this.dom && (this.dom.insertAdjacentHTML("beforeend", this.svg), this.updateUI()), this.cpuAccums.push(0), this.gpuAccums.push(0), this.activeAccums.push(!1));
      }
      /**
       * Increase frameID
...
function $u(e) {
  let t, n, r;
  e.length !== 2 ? (t = Li, n = (s, u) => Li(e(s), u), r = (s, u) => e(s) - u) : (t = e === Li || e === Ov ? e : Nv, n = e, r = e);
...
var ra = Math.sqrt(50), ia = Math.sqrt(10), oa = Math.sqrt(2);
function $v(e, t, n) {
  var r, i = -1, o, f, s;
  if (t = +t, e = +e, n = +n, e === t && n > 0) return [e];
  if ((r = t < e) && (o = e, e = t, t = o), (s = ju(e, t, n)) === 0 || !isFinite(s)) return [];
  if (s > 0) {
    let u = Math.round(e / s), l = Math.round(t / s);
    for (u * s < e && ++u, l * s > t && --l, f = new Array(o = l - u + 1); ++i < o; ) f[i] = (u + i) * s;
  } else {
    s = -s;
    let u = Math.round(e * s), l = Math.round(t * s);
    for (u / s < e && ++u, l / s > t && --l, f = new Array(o = l - u + 1); ++i < o; ) f[i] = (u + i) / s;
...
function jv(e, t, n) {
  ...
  return o >= ra ? i *= 10 : o >= ia ? i *= 5 : o >= oa && (i *= 2), t < e ? -i : i;
}
function Uv(e, t, n) {
...
function qv(e, t, n) {
  var r = e[0], i = e[1], o = t[0], f = t[1];
  return i < r ? (r = aa(i, r), o = n(f, o)) : (r = aa(r, i), o = n(o, f)), function(s) {
    return o(r(s));
  };
}
function Yv(e, t, n) {
  var r = Math.min(e.length, t.length) - 1, i = new Array(r), o = new Array(r), f = -1;
  for (e[r] < e[0] && (e = e.slice().reverse(), t = t.slice().reverse()); ++f < r; )
    i[f] = aa(e[f], e[f + 1]), o[f] = n(t[f], t[f + 1]);
  return function(s) {
    var u = Vv(e, s, 1, r) - 1;
    return o[u](i[u](s));
  };
...
function Hu() {
  var e = eu, t = eu, n = xa, r, i, o, f = tn, s, u, l;
  function v() {
    var S = Math.min(e.length, t.length);
    return f !== tn && (f = Wv(e[0], e[S - 1])), s = S > 2 ? Yv : qv, u = l = null, b;
  }
  function b(S) {
    return S == null || isNaN(S = +S) ? o : (u || (u = s(e.map(r), t, n)))(r(f(S)));
  }
  return b.invert = function(S) {
    return f(i((l || (l = s(t, e.map(r), Ht)))(S)));
  }, b.domain = function(S) {
    return arguments.length ? (e = Array.from(S, Hv), v()) : e.slice();
  }, b.range = function(S) {
    return arguments.length ? (t = Array.from(S), v()) : t.slice();
  }, b.rangeRound = function(S) {
    return t = Array.from(S), n = Rp, v();
  }, b.clamp = function(S) {
    return arguments.length ? (f = S ? !0 : tn, v()) : f !== tn;
...
function Kv(e, t) {
  return function(n, r) {
    for (var i = n.length, o = [], f = 0, s = e[0], u = 0; i > 0 && s > 0 && (u + s + 1 > r && (s = Math.max(1, r - u)), o.push(n.substring(i -= s, i + s)), !((u += s + 1) > r)); )
      s = e[f = (f + 1) % e.length];
...
function ng(e, t) {
  ...
  return o === f ? r : o > f ? r + new Array(o - f + 1).join("0") : o > 0 ? r.slice(0, o) + "." + r.slice(o) : "0." + new Array(1 - o).join("0") + Gi(e, Math.max(0, t + o - 1))[0];
}
function tu(e, t) {
  var n = Gi(e, t);
  if (!n) return e + "";
...
var iu = Array.prototype.map, ou = ["y", "z", "a", "f", "p", "n", "µ", "m", "", "k", "M", "G", "T", "P", "E", "Z", "Y"];
function rg(e) {
  var t = e.grouping === void 0 || e.thousands === void 0 ? ru : Kv(iu.call(e.grouping, Number), e.thousands + ""), n = e.currency === void 0 ? "" : e.currency[0] + "", r = e.currency === void 0 ? "" : e.currency[1] + "", i = e.decimal === void 0 ? "." : e.decimal + "", o = e.numerals === void 0 ? ru : Jv(iu.call(e.numerals, String)), f = e.percent === void 0 ? "%" : e.percent + "", s = e.minus === void 0 ? "−" : e.minus + "", u = e.nan === void 0 ? "NaN" : e.nan + "";
  function l(b) {
    b = Bi(b);
    var S = b.fill, M = b.align, K = b.sign, we = b.symbol, ke = b.zero, ae = b.width, Ne = b.comma, je = b.precision, q = b.trim, pe = b.type;
    pe === "n" ? (Ne = !0, pe = "g") : nu[pe] || (je === void 0 && (je = 12), q = !0, pe = "g"), (ke || S === "0" && M === "=") && (ke = !0, S = "0", M = "=");
    ...
    function rt(ze) {
      ...
      if (pe === "c")
        ...
        ze = +ze;
        var Pe = ze < 0 || 1 / ze < 0;
        if (ze = isNaN(ze) ? u : qe(Math.abs(ze), je), q && (ze = tg(ze)), Pe && +ze == 0 && K !== "+" && (Pe = !1), st = (Pe ? K === "(" ? K : s : K === "-" || K === "(" ? "" : K) + st, tt = (pe === "s" ? ou[8 + Wu / 3] : "") + tt + (Pe && K === "(" ? ")" : ""), et) {
...
function ig(e) {
  return Ti = rg(e), qu = Ti.format, Yu = Ti.formatPrefix, Ti;
}
function og(e) {
  return Math.max(0, -cr(Math.abs(e)));
}
function ag(e, t) {
  return Math.max(0, Math.max(-8, Math.min(8, Math.floor(cr(t) / 3))) * 3 - cr(Math.abs(e)));
}
function sg(e, t) {
  return e = Math.abs(e), t = Math.abs(t) - e, Math.max(0, cr(t) - cr(e)) + 1;
}
function fg(e, t, n, r) {
  var i = jv(e, t, n), o;
  switch (r = Bi(r ?? ",f"), r.type) {
    ...
    case "p":
    case "r": {
      r.precision == null && !isNaN(o = sg(i, Math.max(Math.abs(e), Math.abs(t)))) && (r.precision = o - (r.type === "e"));
      break;
    }
    case "f":
    case "%": {
...
function lg(e) {
  var t = e(tn, tn), n = 1;
  function r() {
    return n === 1 ? e(tn, tn) : n === 0.5 ? e(ug, cg) : e(au(n), au(1 / n));
  }
...
function Qu() {
  var e = lg(Hu());
  return e.copy = function() {
    return Xu(e, Qu()).exponent(e.exponent());
  }, Uu.apply(e, arguments), e;
}
const hg = (e) => {
  const t = Qu().exponent(2).range([0, 1]).domain([-1, 1]), n = Uv(0, e).map((i) => -0.5 + i / e);
  n.push(0.5);
...
function Pg() {
  var e = new su(9);
  return su != Float32Array && (e[1] = 0, e[2] = 0, e[3] = 0, e[5] = 0, e[6] = 0, e[7] = 0), e[0] = 1, e[4] = 1, e[8] = 1, e;
}
function fu(e, t, n) {
  var r = t[0], i = t[1], o = t[2], f = t[3], s = t[4], u = t[5], l = t[6], v = t[7], b = t[8], S = n[0], M = n[1];
  return e[0] = r, e[1] = i, e[2] = o, e[3] = f, e[4] = s, e[5] = u, e[6] = S * r + M * f + l, e[7] = S * i + M * s + v, e[8] = S * o + M * u + b, e;
}
function Ho(e, t, n) {
  var r = n[0], i = n[1];
...
var Rg = Pa.exports, Ku = { exports: {} };
const Dg = {}, Mg = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: Dg
}, Symbol.toStringTag, { value: "Module" })), Og = /* @__PURE__ */ Y0(Mg);
(function(e) {
  (function(t, n, r) {
    var i = 256, o = 6, f = 52, s = "random", u = r.pow(i, o), l = r.pow(2, f), v = l * 2, b = i - 1, S;
    function M(q, pe, De) {
      var Ge = [];
      pe = pe == !0 ? { entropy: !0 } : pe || {};
      var qe = ae(ke(
...
var Ng = Ku.exports, Gg = kg, Bg = Fg, Vg = Lg, $g = zg, jg = Ig, Ug = Rg, jn = Ng;
jn.alea = Gg;
jn.xor128 = Bg;
jn.xorwow = Vg;
jn.xorshift7 = $g;
...
function Ca(e, t, n) {
  return t && Wg(e.prototype, t), Object.defineProperty(e, "prototype", {
    writable: !1
  }), e;
}
function Ju(e, t) {
...
var Xi = /* @__PURE__ */ function() {
  ...
  function t(r, i) {
    var o;
    return o = e.call(this) || this, o._rng = void 0, o.seed(r, i), o;
  }
  var n = t.prototype;
  ...
  var e = [].slice.call(arguments), t = e, n = t[0], r = n === void 0 ? "default" : n;
  switch (typeof r) {
    case "object":
      if (r instanceof Xi)
        return r;
    ...
    case "string":
    default:
      return new uu(Hg.apply(void 0, e));
  }
...
var Qg = function(t) {
  ...
  return t === void 0 && (t = 0), n === void 0 && (n = 1), function() {
    var r, i, o;
    do
      r = e.next() * 2 - 1, i = e.next() * 2 - 1, o = r * r + i * i;
    while (!o || o > 1);
...
}, ox = [0, 0, 0.6931471805599453, 1.791759469228055, 3.1780538303479458, 4.787491742782046, 6.579251212010101, 8.525161361065415, 10.60460290274525, 12.801827480081469], ax = function(t) {
  return ox[t];
}, sx = 0.9189385332046727, fx = function(e, t) {
  if (t === void 0 && (t = 1), qt(t).isPositive(), t < 10) {
    var n = Math.exp(-t);
    return function() {
      for (var u = n, l = 0, v = e.next(); v > u; )
        v = v - u, u = t * u / ++l;
      return l;
    };
  } else {
    ...
    return function() {
      for (; ; ) {
        var u = void 0, l = e.next();
        if (l <= 0.86 * s)
          return u = l / s - 0.43, Math.floor((2 * o / (0.5 - Math.abs(u)) + i) * u + t + 0.445);
        l >= s ? u = e.next() - 0.5 : (u = l / s - 0.93, u = (u < 0 ? -0.5 : 0.5) - u, l = e.next() * s);
  ...
  return t.clone = function() {
    ...
    return r.length ? new e(cu.apply(void 0, r)) : new e(this.rng.clone());
  }, t.use = function() {
...
class mx {
  constructor() {
    this.pointsTextureSize = 0, this.linksTextureSize = 0, this.alpha = 1, this.transform = Pg(), this.backgroundColor = [0, 0, 0, 0], this.screenSize = [0, 0], this.mousePosition = [0, 0], this.screenMousePosition = [0, 0], this.selectedArea = [[0, 0], [0, 0]], this.isSimulationRunning = !1, this.simulationProgress = 0, this.selectedIndices = null, this.maxPointSize = ca, this.hoveredPoint = void 0, this.focusedPoint = void 0, this.draggingPointIndex = void 0, this.adjustedSpaceSize = We.spaceSize, this.isSpaceKeyPressed = !1, this.hoveredPointRingColor = [1, 1, 1, ov], this.focusedPointRingColor = [1, 1, 1, av], this.alphaTarget = 0, this.scalePointX = sa(), this.scalePointY = sa(), this.random = new ec(), this.alphaDecay = (t) => 1 - Math.pow(ua, 1 / t);
  }
  addRandomSeed(t) {
...
const px = { passive: !1 }, Nr = { capture: !0, passive: !1 };
function Wo(e) {
...
function tc(e) {
  var t = e.document.documentElement, n = St(e).on("dragstart.drag", ar, Nr);
...
function bx() {
  var e = vx, t = gx, n = xx, r = yx, i = {}, o = $i("start", "drag", "end"), f = 0, s, u, l, v, b = 0;
  function S(q) {
  ...
  function M(q, pe) {
    if (!(v || !e.call(this, q, pe))) {
      var De = je(this, t.call(this, q, pe), q, pe, "mouse");
      De && (St(q.view).on("mousemove.drag", K, Nr).on("mouseup.drag", we, Nr), tc(q.view), Wo(q), l = !1, s = q.clientX, u = q.clientY, De("start", q));
    }
  }
  function K(q) {
    if (ar(q), !l) {
  ...
  return S.filter = function(q) {
    return arguments.length ? (e = typeof q == "function" ? q : Ai(!!q), S) : e;
...
function Ex(e, t, n) {
  var r = e.invertX(t[0][0]) - n[0][0], i = e.invertX(t[1][0]) - n[1][0], o = e.invertY(t[0][1]) - n[0][1], f = e.invertY(t[1][1]) - n[1][1];
  return e.translate(
...
function Px() {
  var e = Sx, t = wx, n = Ex, r = Tx, i = Ax, o = [0, 1 / 0], f = [[-1 / 0, -1 / 0], [1 / 0, 1 / 0]], s = 250, u = $p, l = $i("start", "zoom", "end"), v, b, S, M = 500, K = 150, we = 0, ke = 10;
  function ae(N) {
    N.property("__zoom", lu).on("wheel.zoom", qe, { passive: !1 }).on("mousedown.zoom", et).on("dblclick.zoom", rt).filter(i).on("touchstart.zoom", ze).on("touchmove.zoom", st).on("touchend.zoom touchcancel.zoom", tt).style("-webkit-tap-highlight-color", "rgba(0,0,0,0)");
  }
  ...
  function et(N, ...Te) {
    ...
    var oe = N.currentTarget, Pe = De(this, Te, !0).event(N), $e = St(N.view).on("mousemove.zoom", ut, !0).on("mouseup.zoom", Gt, !0), Be = un(N, oe), Ye = N.clientX, nt = N.clientY;
  ...
  function ze(N, ...Te) {
    if (e.apply(this, arguments)) {
      ...
      for (qo(N), Ye = 0; Ye < Pe; ++Ye)
        nt = oe[Ye], ut = un(nt, this), ut = [ut, this.__zoom.invert(ut), nt.identifier], $e.touch0 ? !$e.touch1 && $e.touch0[2] !== ut[2] && ($e.touch1 = ut, $e.taps = 0) : ($e.touch0 = ut, Be = !0, $e.taps = 1 + !!v);
  ...
  return ae.wheelDelta = function(N) {
    ...
    return arguments.length ? (e = typeof N == "function" ? N : Ei(!!N), ae) : e;
...
class Cx {
  constructor(t, n) {
    ...
    }), this.isRunning = !1, this.store = t, this.config = n;
  }
  /**
...
class kx {
  constructor(t, n) {
    this.isActive = !1, this.behavior = bx().subject((r) => this.store.hoveredPoint && !this.store.isSpaceKeyPressed ? { x: r.x, y: r.y } : void 0).on("start", (r) => {
      var i, o;
      ...
      var i, o;
      this.isActive = !1, this.store.draggingPointIndex = void 0, (o = (i = this.config) == null ? void 0 : i.onDragEnd) == null || o.call(i, r);
    }), this.store = t, this.config = n;
  }
}
class Fx {
  constructor(t, n) {
    this.config = new hv(), this.graph = new Rv(this.config), this.requestAnimationFrameId = 0, this.isRightClickMouse = !1, this.store = new mx(), this.zoomInstance = new Cx(this.store, this.config), this.dragInstance = new kx(this.store, this.config), this._findHoveredPointExecutionCount = 0, this._isMouseOnCanvas = !1, this._isFirstRenderAfterInit = !0, this._hasPointPositionsChanged = !1, this._hasPointColorsChanged = !1, this._hasPointSizesChanged = !1, this._hasLinksChanged = !1, this._hasLinkColorsChanged = !1, this._hasLinkWidthsChanged = !1, this._hasLinkArrowsChanged = !1, this._hasPointClustersChanged = !1, this._hasClusterPositionsChanged = !1, this._hasPointClusterForceChanged = !1, n && this.config.init(n);
    ...
    t.width = r * this.config.pixelRatio, t.height = i * this.config.pixelRatio, t.style.width === "" && t.style.height === "" && St(t).style("width", "100%").style("height", "100%"), this.canvas = t, this.canvasD3Selection = St(t), this.canvasD3Selection.on("mouseenter.cosmos", () => {
      ...
      o.code === "Space" && (this.store.isSpaceKeyPressed = !0);
    }).on("keyup.cosmos", (o) => {
      o.code === "Space" && (this.store.isSpaceKeyPressed = !1);
   ...
   */
  setPointPositions(t) {
    this.graph.inputPointPositions = t, this._hasPointPositionsChanged = !0;
  }
  /**
  ...
  */
  setPointColors(t) {
    this.graph.inputPointColors = t, this._hasPointColorsChanged = !0;
  }
  /**
   ...
   */
  setPointSizes(t) {
    this.graph.inputPointSizes = t, this._hasPointSizesChanged = !0;
  }
  /**
   ...
   */
  setLinks(t) {
    this.graph.inputLinks = t, this._hasLinksChanged = !0;
  }
  /**
   ...
   */
  setLinkColors(t) {
    this.graph.inputLinkColors = t, this._hasLinkColorsChanged = !0;
  }
  /**
   ...
   */
  setLinkWidths(t) {
    this.graph.inputLinkWidths = t, this._hasLinkWidthsChanged = !0;
  }
  /**
   ...
   */
  setLinkArrows(t) {
    this.graph.linkArrowsBoolean = t, this._hasLinkArrowsChanged = !0;
  }
  /**
   ...
   */
  setPointClusters(t) {
    this.graph.inputPointClusters = t, this._hasPointClustersChanged = !0;
  }
  /**
  ...
  setClusterPositions(t) {
    this.graph.inputClusterPositions = t, this._hasClusterPositionsChanged = !0;
  }
  /**
  ...
  setPointClusterStrength(t) {
    this.graph.inputClusterStrength = t, this._hasPointClusterForceChanged = !0;
  }
  /**
   * Renders the graph.
   *
  ...
  render(t) {
    ...
    }, r)), this._isFirstRenderAfterInit = !1, this.update(t);
  }
  /**
   ...
   */
  zoomToPointByIndex(t, n = 700, r = sv, i = !0) {
  ...
  start(t = 1) {
    var n, r;
    this.graph.pointsNumber && (this.store.isSimulationRunning = !0, this.store.alpha = t, this.store.simulationProgress = 0, (r = (n = this.config).onSimulationStart) == null || r.call(n), this.stopFrames(), this.frame());
  }
  /**
  ...
  pause() {
    var t, n;
    this.store.isSimulationRunning = !1, (n = (t = this.config).onSimulationPause) == null || n.call(t);
  }
  /**
  ...
  restart() {
    var t, n;
    this.store.isSimulationRunning = !0, (n = (t = this.config).onSimulationRestart) == null || n.call(t);
  }
  /**
  ...
  create() {
    var t, n, r, i, o;
    this._hasPointPositionsChanged && this.points.updatePositions(), this._hasPointColorsChanged && this.points.updateColor(), this._hasPointSizesChanged && this.points.updateSize(), (this._hasLinksChanged || this._hasPointPositionsChanged) && this.lines.updatePointsBuffer(), this._hasLinkColorsChanged && this.lines.updateColor(), this._hasLinkWidthsChanged && this.lines.updateWidth(), this._hasLinkArrowsChanged && this.lines.updateArrow(), this.lines.updateCurveLineGeometry(), (t = this.forceManyBody) == null || t.create(), (n = this.forceLinkIncoming) == null || n.create(na.INCOMING), (r = this.forceLinkOutgoing) == null || r.create(na.OUTGOING), (i = this.forceCenter) == null || i.create(), (this._hasPointClustersChanged || this._hasClusterPositionsChanged || this._hasPointClusterForceChanged) && ((o = this.clusters) == null || o.create()), this._hasPointPositionsChanged = !1, this._hasPointColorsChanged = !1, this._hasPointSizesChanged = !1, this._hasLinksChanged = !1, this._hasLinkColorsChanged = !1, this._hasLinkWidthsChanged = !1, this._hasLinkArrowsChanged = !1, this._hasPointClustersChanged = !1, this._hasClusterPositionsChanged = !1, this._hasPointClusterForceChanged = !1;
  }
  /**
  ...
  stopFrames() {
    ...
    var t, n;
    this.store.isSimulationRunning = !1, this.store.simulationProgress = 1, (n = (t = this.config).onSimulationEnd) == null || n.call(t);
  }
  onClick(t) {
    var n, r, i, o;
  ...
  findHoveredPoint() {
    ...
    if (r[1]) {
      const v = r[0];
      ((o = this.store.hoveredPoint) == null ? void 0 : o.index) !== v && (t = !0);
      const b = r[2], S = r[3];
